                                    ...
                                    <div className="container">
                                        <div className="row">
                                            ...
                                            <div className="col-12">
                                                {user.requestcode != null ? (user.requestcode === 1 ? <div className="alert alert-green shadow">Successfully created user.</div> :
                                            ...
                                            <div className="col-12 mb-4">
                                                ...
                                                />
                                                <small className="text-darkgreen">By pressing Register, you are accepting to our Terms and conditions.</small>
                                            </div>
