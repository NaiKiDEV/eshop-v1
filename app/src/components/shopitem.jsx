            ...
            <div className="card shadow-sm">
                <div className="card-body shadow">
                    ...
                    <div className="item-specials">
                        ...
                        {product.discount ? <span className="badge rounded-pill badge-red ms-2">Discount</span> : ""}
                    </div>
                ...
                <div className="card-footer item-price bg-lightblue d-flex align-items-center py-0 ">
                    <div className="container-fluid px-0">
                        <div className="row">
                            <div className="col-4 d-flex align-items-center animate">
                            ...
                            <div className="col-8 d-flex justify-content-end ">
                                <h5 className="text-darkblue item-pricetag mb-0">
                                    {product?.discount ? <span>{product.discount}€<small className="text-strikethrough text-red">{product.price}€</small></span> : product.price + " €"}
